package com.deepak.bookingservice.constants;

public class LoggingConstants {
	
	public static final String BASE_PACKAGE = "com.deepak.bookingservice.*";
	...
	public static final String POINT_CUT_BASE_PACKAGE = "execution(* com.deepak.bookingservice..*.*(..))";
